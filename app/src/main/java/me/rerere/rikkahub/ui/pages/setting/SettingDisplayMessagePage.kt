        ...
        LazyColumn(
            ...
            item {
                CardGroup(
                    ...
                    item(
                        headlineContent = { Text("显示思考时间") },
                        supportingContent = { Text("关闭后不显示思考耗时") },
                        trailingContent = {
                            Switch(
                                checked = displaySetting.showThinkingTime,
                                onCheckedChange = {
                                    updateDisplaySetting(displaySetting.copy(showThinkingTime = it))
                                }
                            )
                        },
                    )
