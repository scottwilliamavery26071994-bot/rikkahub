...
<p>基于 <a href="https://github.com/rikkahub/rikkahub">Lingxi</a> 深度定制的 Android AI 客户端<br/>在原生聊天体验之上，构建了完整的插件生态与智能生活服务</p>
...
原版 Lingxi 是一个优秀的 AI 聊天客户端，支持多供应商、MCP 协议、富文本渲染等功能。
...
- **[Lingxi](https://github.com/rikkahub/rikkahub)** — 灵犀的原版基础，一个优秀的 Android AI 聊天客户端
- 所有为灵犀开发插件的社区成员
