        ...
        LazyColumn(
            ...
            item("modelServices") {
                CardGroup(
                    ...
                    item(
                        onClick = { navController.navigate(Screen.SettingApkReverse) },
                        leadingContent = { Icon(HugeIcons.Archive01, null) },
                        supportingContent = { Text("选择 APK 文件，分析包名/权限/接口") },
                        headlineContent = { Text("APK 逆向分析") },
                    )
                    item(
